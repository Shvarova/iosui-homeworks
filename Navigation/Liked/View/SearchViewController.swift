...
//  Navigation
//
//  Created by Дина Шварова on 20.04.2023.
//

import UIKit

final class SearchViewController: UIViewController {
    var delegate: LikedViewControllerDelegate?
    ...
    private lazy var searchButton: CustomButton = {
        let button = CustomButton(title: "Найти", titleColor: .white, cornerRadius: 5)
    ...
    @objc private func searchButtonTouched() {
        delegate?.setAuthorFilter(author: textField.text ?? "")
